...
import {
  ...
  updateCategory,
  deleteCategory,
} from '@api/client/services/categories'
...
export const useCreateCategory = () => {
  ...
  return useMutation((categoryData: CreateCategoryRequest) => createCategory(categoryData), {
...
export const useDeleteCategory = () => {
  const queryClient = useQueryClient()
  return useMutation((categoryId: CategoryId) => deleteCategory(categoryId), {
    onSuccess: () => queryClient.invalidateQueries(['categories']),
  })
}
